...
const About = () => {
  return (
    <section id="about" className="bg-white dark:bg-gray-900 dark:text-white">
      <div className="section-container bg-gray-900 dark:text-white">
        <div className="max-w-4xl mx-auto bg-gray-900 dark:text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">
            <span className="title-highlight">About Me</span>
          </h2>
          <p className="text-theme-light-blue mb-12">Get to know my story</p>
          
          <div className="grid md:grid-cols-2 gap-8 items-start mb-12 dark:bg-gray-900 dark:text-white">
            <div>
              <p className="text-gray-700 mb-4 dark:bg-gray-900 dark:text-white">
            ...
            <div className="bg-theme-bg rounded-lg p-6 shadow-sm dark:bg-gray-900 dark:text-white">
              <h3 className="text-xl font-semibold mb-4 dark:bg-gray-900 dark:text-white">Quick Bio</h3>
              
              <div className="space-y-4 dark:bg-gray-900 dark:text-white">
                <div className="flex items-start gap-3 dark:bg-gray-900 dark:text-white">
                ...
                <div className="flex items-start gap-3 dark:bg-gray-900 dark:text-white">
                  <Briefcase className="text-theme-accent mt-1 dark:bg-gray-900 dark:text-white" size={20} />
                  <div>
                ...
                <div className="flex items-start gap-3 dark:bg-gray-900 dark:text-white">
                  <Book className="text-theme-accent mt-1 dark:bg-gray-900 dark:text-white" size={20} />
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 dark:bg-gray-900 dark:text-white">
            {highlights.map((item, index) => (
              <Card key={index} className="border-t-4 border-t-theme-accent dark:bg-gray-900 dark:text-white">
                <CardContent className="pt-6 dark:bg-gray-900 dark:text-white">
                  <h3 className="font-bold text-lg mb-2 dark:bg-gray-900 dark:text-white">{item.title}</h3>
                  <p className="text-gray-700 dark:bg-gray-900 dark:text-white">{item.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
